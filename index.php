...
<section class="top-60">
    <div class="community-banner ">
        <div class="wrapperjoke">
                    ...
                    <div class="row row__50 mobile-full">
                        <div class="project project__1st">
                            ...
                            <div class="project__comment">
                                ...
                                <a href="" target="_blank"><img class="project__comment--avatar" src="assets/images/p1-ic.png" alt=""/></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row__50 mobile-full add-2">
                        <div class="project project__2nd">
                            ...
                            <div class="project__comment">
                                ...
                                <img class="project__comment--avatar" src="assets/images/p2-ic.png" alt=""/>
                            </div>
                        </div>
                        ...
                        <div class="flex-container-comm mobile-50">
                            <div class="project project__3rd row row__50 mobile-full add-2">
                                ...
                                <div class="project__comment">
                                    ...
                                    <img class="right" src="assets/images/p3-ic.png" alt=""/>
                                </div>
                            </div>
            ...
            <div class="flex-container-comm">
                <div class="row__25 project project__5th">
                    ...
                    <div class="project__comment no-bottom">
                        ...
                        <p class="project__comment--content2">0 Comments</p>
                        <img class="right" src="assets/images/p5-ic.png" alt=""/>
                    </div>
                </div>
                <div class="row row__50 project project__6th">
                    ...
                    <div class="project__comment top-7__mobile">
                        <img class="project__comment--ic" src="assets/images/p1-com.png" alt=""/>
                        <p class="">0 Comments</p>
                        <img class="right" src="assets/images/p6-ic.png" alt=""/>
                    </div>
                </div>
                <div class="row__25 project project__7th">
                    ...
                    <div class="project__comment no-bottom">
                        <img class="project__comment--ic" src="assets/images/comment-ic.png" alt=""/>
                        <p class="project__comment--content2">0 Comments</p>
                        <img class="right" src="assets/images/p7-ic.png" alt=""/>
                    </div>
                </div>
            </div>
            ...
            <div class="banner__down-arrow">
                <a class="jumper" href="#four"><img class="top-60 bottom-30" src="assets/images/down-arrow.PNG" alt=""/></a>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="text-container2 top-50">
            <div class="flex-container2">
                <div class="row row__25 no-bottom"><img src="assets/images/stateuniv.png" alt="" class="image-hover" /></div>
                <div class="row row__25  no-bottom"><img src="assets/images/campbell.png" alt="" class="image-hover" /></div>
                <div class="row row__25  no-bottom"><img src="assets/images/academy.png" alt="" class="image-hover" /></div>
                <div class="row row__25  no-bottom"><img src="assets/images/texas.png" alt="" class="image-hover" /></div>
            </div>

            <div class="flex-container2">
                <div class="row row__25"><img src="assets/images/NSBE.png" alt="" class="image-hover" /></div>
                <div class="row row__25"><img src="assets/images/mytv.png" alt="" class="image-hover" /></div>
                <div class="row row__25"><img src="assets/images/intel.png" alt="" class="image-hover" /></div>
                <div class="row row__25"><img src="assets/images/imhotep.png" alt="" class="image-hover" /></div>
            </div>

            <div class="banner__down-arrow">
                <a class="jumper" href="#five"><img class="top-60 bottom-30" src="assets/images/blue-down-arrow.png" alt=""/></a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="flex-container-ourservices">
                <div class="flex-container-ourservices__mobile row row__33 box-white text-center service-shadow top-25">
                    <div class="video-production">
                        <img src="assets/images/vpro-ic.png" alt=""/>
                        <p class="box-white__title no-bottom top-20">VIDEO</br>PRODUCTION
                        </p>
                ...
                <div class="flex-container-ourservices__mobile row row__33 box-white text-center service-shadow top-40">
                    <div class="live-events">
                        <img src="assets/images/event-ic.png" alt=""/>
                        <p class="box-white__title no-bottom top-20">LIVE</br>EVENTS</p>
